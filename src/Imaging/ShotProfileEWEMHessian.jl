function ShotProfileEWEMHessian(w::Array{ASCIIString,1},d::Array{ASCIIString,1};pspi=true,nref=5,vp="vp.seis",vs="vs.seis",angx="angx.seis",angy="angy.seis",wav="wav.seis",sz=0.,gz=0.,nangx=1,oangx=0,dangx=1,nangy=1,oangy=0,dangy=1,fmin=0,fmax=80,padt=1,padx=1,verbose=false,sx=[0],sy=[0],kz_eps=0.0005)
	...
	SeisSmooth2(mref_env[1],mref_env_s[1];key=["iaz";"iang"],L1=7,L2=7)
	SeisSmooth2(mref_env[2],mref_env_s[2];key=["iaz";"iang"],L1=7,L2=7)
	SeisSmooth2(mref_env[3],mref_env_s[3];key=["iaz";"iang"],L1=7,L2=7)
	...
	SeisSmooth2(mref_fwd_adj_env[1],mref_fwd_adj_env_s[1];key=["iaz";"iang"],L1=7,L2=7)
	SeisSmooth2(mref_fwd_adj_env[2],mref_fwd_adj_env_s[2];key=["iaz";"iang"],L1=7,L2=7)
	SeisSmooth2(mref_fwd_adj_env[3],mref_fwd_adj_env_s[3];key=["iaz";"iang"],L1=7,L2=7)
	# normalize
