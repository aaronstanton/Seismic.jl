function ShotProfileLSWEM(m::ASCIIString,d::ASCIIString;Niter=10,mu=0.,cost="cost.txt",precon=false,Nsmooth=5,tmute=0.6,vmute=1500.,pspi=true,nref=5,vel="vp.seis",angx="angx.seis",angy="angy.seis",wav="wav.seis",sz=0.,gz=0.,nangx=1,oangx=0,dangx=1,nangy=1,oangy=0,dangy=1,fmin=0,fmax=80,padt=1,padx=1,verbose=false,sx=[0],sy=[0],kz_eps=0.0005)
	...
	@compat param_mig = Dict(:pspi=>pspi,:nref=>nref,:vel=>vel,:angx=>angx,:angy=>angy,:wav=>wav,:sz=>sz,:gz=>gz,:nangx=>nangx,:oangx=>oangx,:dangx=>dangx,:nangy=>nangy,:oangy=>oangy,:dangy=>dangy,:fmin=>fmin,:fmax=>fmax,:padt=>padt,:padx=>padx,:verbose=>verbose,:sx=>sx,:sy=>sy,:kz_eps=>kz_eps)
	if (precon)
